...
const formatLabel = (key: string): string => {
  // Remove 'total_' prefix and format the rest
  const label = key
    .replace("total_", "")
    .replace(/_/g, " ")
...
const Main: React.FC = () => {
  ...
  const searchParams = useSearchParams(); // for role switching reload
  ...
  useEffect(() => {
    ...
    if (switchParam === "true") {
      window.location.href = `${window.location.origin}/tutor/dashboard`;
