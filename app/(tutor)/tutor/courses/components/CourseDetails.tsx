...
const CourseDetails =({ Course, onClose }: any) => {
      ...
      <Container fluid className="mt-4 px-4">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <Link href="/tutor/online-classes" className="text-decoration-none">
            <Button variant="outline-primary" className="d-flex align-items-center" onClick={onClose}>
              <i className="bi bi-arrow-left me-2"></i>
              Back to Courses
            </Button>
          </Link>
          <div className="d-flex gap-2">
            <Link href={`/tutor/online-classes/${courseId}/manage-course`}>
              <Button variant="success" className="d-flex align-items-center">
                <i className="bi bi-list me-2"></i>
                Manage Course
              </Button>
            </Link>
            <Link href={`/tutor/online-classes/${courseId}/edit`}>
                    ...
                    <div className="mt-4">
                      ...
                      <div className="ratio ratio-16x9 rounded-3 overflow-hidden shadow-sm">
                        <video controls className="rounded-3">
                          <source
                            src={`${baseUrl}/uploads/courses/introvideo/${course.course_intro_video}`}
                            type="video/mp4"
                          />
