...
const EditPlanForm = ({ set_is_editing, data, get_plans, set_data, is_editing, showToast }: EditPlanFormProps) => {
  ...
  const update_plan = async (e: FormEvent) => {
    e.preventDefault();
    if (!data?.id) return;
    // Only check for empty fields, not for changes
    if (
      plan_name === '' ||
      plan_description === '' ||
      plan_duration === 0 ||
      ...
      if (showToast) showToast.error("All fields are required");
      else set_error_message("All fields are required");
    ...
    try {
      ...
      if (showToast) showToast.success("Plan updated successfully");
      else set_success_message("Plan updated successfully");
      ...
      set_is_loading(false);
      if (showToast) showToast.error("Something went wrong, please try again later.");
      else set_error_message("Something went wrong, please try again later.");
      setTimeout(() => set_error_message(""), 3000);
    }
  };
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <form onSubmit={update_plan}>
                  ...
                  {/* Responsive Row: Plan Price, Duration, Plan Medium */}
                  <div className="row">
                  ...
                  {/* Responsive Row: Tutors Allowed, Courses Allowed, Storage Allowed */}
                  <div className="row">
                    <div className="col-12 col-md-4 mb-3">
                    ...
                    <div className="col-12 col-md-4 mb-3">
                      <label htmlFor="storage_allowed" className="form-label">Storage Allowed (GB)</label>
                      <input
                        type="number"
                        className="form-control"
                        id="storage_allowed"
