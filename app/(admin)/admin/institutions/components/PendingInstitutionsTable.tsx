    ...
    <div className="modal-dialog modal-dialog-centered modal-lg">
        <div className="modal-content">
            ...
            <div className="modal-body">
                <div className="row align-items-center mb-4">
                    <div className="col-auto position-relative">
                        <Image alt={selectedInstitute.name} src={ selectedInstitute.profile_image ?
                            `${baseUrl}/${selectedInstitute.profile_image}` : profilePicture } width={80} height={80}
                            className="rounded-circle border border-3 border-primary" onError={(e:
                            ...
                            />
                            <span className={`position-absolute bottom-0 end-0 badge rounded-pill bg-${getStatusColor(
                                user_status )}`}>
                    ...
                    <div className="col">
                        <h4 className="mb-1">{selectedInstitute.name}</h4>
                    ...
                    <div className="col-md-4">
                        ...
                        <select className="form-select" value={user_status} onChange={(e)=>
                            set_user_status(e.target.value)}
                            >
                ...
                <div className="row g-3">
                            ...
                            <div className="card-body">
                                ...
                                <div className="row g-3">
                                    <div className="col-md-6">
                                        ...
                                        <p>{selectedInstitute.address || "N/A"}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title fw-bold mb-3">
                                    <i className="bi bi-file-text me-2"></i> Registration
                                    Information
                                </h5>
                                <div className="row g-3">
                                    <div className="col-md-6">
                                        ...
                                        <p>{selectedInstitute.registration_number || "N/A"}</p>
                                    </div>
                                    <div className="col-md-6">
                                        <label className="form-label fw-bold">TIN Number</label>
                                        <p>{selectedInstitute.tin_number || "N/A"}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="row g-3">
                                    <div className="col-md-6">
                                        ...
                                        <p>
                                            ...
                                            ? moment(selectedInstitute.created_at).format(
                                            "MMMM D, YYYY"
                                            )
                                            : "N/A"}
                                        </p>
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <p>
                                            ...
                                            ? moment(selectedInstitute.updated_at).format(
                                            "MMMM D, YYYY"
                                            )
                                            : "N/A"}
                                        </p>
                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title fw-bold mb-3">
                                    <i className="bi bi-file-earmark me-2"></i> Supporting
                                    Document
                                </h5>
                                {selectedInstitute?.supporting_document ? (
                                <FilePreview fileName={selectedInstitute.supporting_document}
            ...
            <div className="modal-footer">
                ...
                <button type="button" className="btn btn-primary" disabled={user_status===selectedInstitute.status ||
                    is_loading} onClick={update_institute}>
                    {is_loading ? (
                    <>
...
const tableRef = useRef<HTMLTableElement>(null);
    ...
    useState<InstituteData | null>(null);
        ...
        // @ts-ignore
        new bootstrap.Modal(document.getElementById("viewInstituteModal")).show();
        }
        } catch (error: any) {
                       ...
                       .map((institute: InstituteData, index: number) => (
                        ...
                        <tr key={institute.institute_id || index}>
                          ...
                          textTransform: "capitalize",
                            ...
                            <td>
                                <button className="btn btn-sm btn-view rounded-pill text-white" onClick={()=>
