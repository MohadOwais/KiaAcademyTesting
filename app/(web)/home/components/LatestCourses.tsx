...
//                     <h2 className="mb-0 heading-style">Latest Courses</h2>
...
//                                     >
//                                         <div
//                                             className={`level-indicator ${course.course_level?.toLowerCase() === 'beginner'
//                                                     ? 'beginner'
...
const LatestCourses = () => {
    ...
    // Get current page's courses
    const currentCourses = courses.slice(currentPage * 4, (currentPage + 1) * 4);
            ...
            <div className="container-fluid" style={{ maxWidth: '1800px' }}>
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div className="d-flex align-items-center">
                        <div style={{ width: '5px', height: '38px', background: 'var(--color-dark-2, #1778bc)', borderRadius: '4px', marginRight: '16px' }}></div>
                        <h2 className="mb-0 heading-style">Latest Courses</h2>
                    </div>
                    <div className="slider-controls">
                        <Button
                ...
                {isLoading ? (
                    ...
                    <div className="courses-container">
                        <div className="row g-4">
                            {currentCourses.map((course: any) => (
                                <div key={course.course_id} className="col-md-3">
                                    <div
