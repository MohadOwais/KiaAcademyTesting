...
const PopularColleges = () => {
    ...
    const getColleges = async () => {
        ...
        try {
            ...
            if (resp?.data?.data) {
                setColleges(resp.data.data.filter((i: any) => i.institute_type?.toLowerCase() === "college").slice(0, 12));
            }
        } catch (error) {
    ...
    const totalPages = Math.ceil(colleges.length / 4);
    ...
    const currentColleges = colleges.slice(currentPage * 4, (currentPage + 1) * 4);
            ...
            <div className="container-fluid" style={{ maxWidth: '1800px' }}>
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div className="d-flex align-items-center">
                        <div style={{ width: '5px', height: '38px', background: '#1778bc', borderRadius: '4px', marginRight: '16px' }}></div>
                        <h2 className="mb-0 heading-style">Popular Colleges</h2>
                    </div>
                            ...
                            {currentColleges.map((inst: any) => (
                                <div key={inst.institute_id} className="col-md-3">
                                    <div
                                        ...
                                        onClick={() => router.push(`/colleges/${inst.institute_id}`)}
                                    >
