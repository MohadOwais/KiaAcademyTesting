...
const PopularInstitutes = () => {
    ...
    const getInstitutes = async () => {
        ...
        try {
            ...
            if (resp?.data?.data) {
                // Only 'institute' type
                setInstitutes(resp.data.data.filter((i: any) => i.institute_type?.toLowerCase() === "institute").slice(0, 12));
            }
        } catch (error) {
    ...
    const totalPages = Math.ceil(institutes.length / 4);
    ...
    const currentInstitutes = institutes.slice(currentPage * 4, (currentPage + 1) * 4);
            ...
            <div className="container-fluid" style={{ maxWidth: '1800px' }}>
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div className="d-flex align-items-center">
                        <div style={{ width: '5px', height: '38px', background: '#62c824', borderRadius: '4px', marginRight: '16px' }}></div>
                        <h2 className="mb-0 heading-style">Popular Institutes</h2>
                    </div>
                ...
                {isLoading ? (
                    ...
                    <div className="institutes-container">
                        <div className="row g-4">
                            {currentInstitutes.map((inst: any) => (
                                <div key={inst.institute_id} className="col-md-3">
                                    <div
                                        ...
                                        onClick={() => router.push(`/institutes/${inst.institute_id}`)}
                                    >
