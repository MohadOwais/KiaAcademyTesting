...
const PopularUniversities = () => {
    ...
    const getUniversities = async () => {
        ...
        try {
            ...
            if (resp?.data?.data) {
                setUniversities(resp.data.data.filter((i: any) => i.institute_type?.toLowerCase() === "university").slice(0, 12));
            }
        } catch (error) {
    ...
    const totalPages = Math.ceil(universities.length / 4);
    ...
    const currentUniversities = universities.slice(currentPage * 4, (currentPage + 1) * 4);
            ...
            <div className="container-fluid" style={{ maxWidth: '1800px' }}>
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <div className="d-flex align-items-center">
                        <div style={{ width: '5px', height: '38px', background: '#ffb300', borderRadius: '4px', marginRight: '16px' }}></div>
                        <h2 className="mb-0 heading-style">Popular Universities</h2>
                    </div>
                ...
                {isLoading ? (
                    ...
                    <div className="universities-container">
                        <div className="row g-4">
                            {currentUniversities.map((inst: any) => (
                                <div key={inst.institute_id} className="col-md-3">
                                    <div
                                        ...
                                        onClick={() => router.push(`/universities/${inst.institute_id}`)}
                                    >
