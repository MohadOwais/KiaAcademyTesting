  ...
  const handleDelete = async () => {
    try {
      ...
      if (response.data.status === 200) {
        ...
        router.push('/institution/tutor/online-classes');
      } else {
    ...
    <>
      <Container fluid className="mt-4 px-4">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <Link href="/institution/tutor/online-classes" className="text-decoration-none">
          ...
          <div className="d-flex gap-2">
            <Link href={`/institution/tutor/online-classes/${courseId}/manage-course`}>
              <Button  className="d-flex align-items-center btn-view rounded-pill">
                <i className="bi bi-list me-2"></i>
                Manage Course
              </Button>
            </Link>
            <Link href={`/institution/tutor/online-classes/${courseId}/edit`}>
              <Button  className="d-flex align-items-center btn-view rounded-pill">
