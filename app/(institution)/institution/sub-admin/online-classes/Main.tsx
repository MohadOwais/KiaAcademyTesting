            ...
            {isLoading ? (
              ...
              currentCourses.map((course) => (
                <tr key={course.course_id}>
                  <td>
                    <Link href={`/institution/sub-admin/online-classes/${course.course_id}`} className="text-decoration-none">
                      {course.course_title}
                    </Link>
                  </td>
                  ...
                  <td>
                    <div className="d-flex justify-content-center gap-2">
                         <Link
                        href={`/institution/sub-admin/online-classes/${course.course_id}`}
                        className="btn btn-sm btn-primary"
                      >
                        <i className="bi bi-eye"></i>
                      </Link>
                      <Link
                        href={`/institution/sub-admin/online-classes/${course.course_id}/edit`}
                        className="btn btn-sm btn-primary"
                      >
